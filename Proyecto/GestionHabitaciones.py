...
###################################################################### Creacion de Frames #######################################################################################
        self.frameDatos=tk.Frame(self.ventanaHome,highlightbackground="white", highlightcolor="white", highlightthickness=3, bd=0, padx=20, pady=20)
        self.frameDatos.config(width=650,height=275) 
        self.frameDatos.place(x=600,y=85)
        self.frameDatos.configure(bg="#181818")
        
        self.frameDatos1=tk.Frame(self.ventanaHome,highlightbackground="white", highlightcolor="white", highlightthickness=3, bd=0, padx=20, pady=20)
        self.frameDatos1.config(width=650,height=315)#335 
        self.frameDatos1.place(x=600,y=375)
        self.frameDatos1.configure(bg="#181818")
        #labels
...
#########################################################################  Frame 1  #################################################################################################
        ...
        self.labelSmart=tk.Label(self.frameDatos,text="Smart TV: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelWifi=tk.Label(self.frameDatos,text="WI-FI: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelAC=tk.Label(self.frameDatos,text="A/C: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelCalidad=tk.Label(self.frameDatos,text="Calidad: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelPrecio=tk.Label(self.frameDatos,text="Precio: ",background="#181818", foreground="white",font=('times 14 bold italic'))
...
#########################################################################  Frame 2  ####################################################################################################
        ...
        self.labelApellido=tk.Label(self.frameDatos1,text="Apellido: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelDNI=tk.Label(self.frameDatos1,text="DNI: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelTelefono=tk.Label(self.frameDatos1,text="Telefono: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelEstadia=tk.Label(self.frameDatos1,text="Estadia: ",background="#181818", foreground="white",font=('times 14 bold italic'))
        ...
        self.labelCheckin = tk.Label(self.frameDatos1,text="Check in: ",bg="#181818", fg= "white", font=('times 14 bold italic'))
        ...
        self.labelCheckout = tk.Label(self.frameDatos1, text="Check out: ", bg="#181818", fg="white", font=('times 14 bold italic'))
...
############################################################################# Labels  ##############################################################################################
        ...
        self.frameTitulo.config(background = "#181818", foreground="white",font='times 28 bold italic underline')#34
        self.frameTitulo.pack(anchor=CENTER)
        self.piso1=ttk.Label(self.ventanaHome, text="Piso 1")
        self.piso1.config(background = "#181818", foreground="white",font='times 16 bold italic underline')
        self.piso1.place(x=95, y=75)
        self.piso2=ttk.Label(self.ventanaHome, text="Piso 2")
        self.piso2.config(background = "#181818", foreground="white",font='times 16 bold italic underline')
        self.piso2.place(x=275, y=75)
        self.piso3=ttk.Label(self.ventanaHome, text="Piso 3")
        self.piso3.config(background = "#181818", foreground="white",font='times 16 bold italic underline')
...
#############################################################################  botones ############################################################################################
        self.botonConfirmar = tk.Button(self.frameDatos, text="Confirmar Habitacion", bg="green", fg="white" ,font=('times 14 bold italic'),  command= lambda: self.ConfirmarDato(habEntry))
        ...
        for j in range(self.columna): 
            for i in range(self.fila):
                ...
                self.labelFila=tk.Label(self.ventanaHome,text=self.contadorNombre,fg="white", bg="#181818")
