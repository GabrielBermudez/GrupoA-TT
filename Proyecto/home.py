...
class Luxury:
    ...
    def FrontHome(self):
        ...
        #creacion de label
        #Imagen
        """self.pic = "D:\Programacion\Segundo Semestre\GrupoA-TT\Proyecto\imagenes\logo.PNG"
        self.pic1 = p.Image.open(pic)
        self.photo = ptk.PhotoImage(pic1)
        
        self.label1 = tkr.Label(ventanaHome, image=photo)
        self.label1.pack()"""
